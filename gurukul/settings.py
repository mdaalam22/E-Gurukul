...
SECRET_KEY = '7x*eft%i6xdh4$&1x72fgyuix$cv6%1dn*c!1biftuezjni7ox'
...
ASGI_APPLICATION = 'gurukul.routing.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR,'gurukul/static')]
